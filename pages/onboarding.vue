		...
		<template v-else>
			<div class="flex items-center min-h-screen">
				<div class="w-full mdlg:w-1/2 p-8">
					<BaseText as="h3" size="md" class="mb-6 text-center"
						>Choose account type</BaseText
					>
					<div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
						<NuxtLink
							...
							:class="[
								user.bgClass,
								'flex flex-col items-center justify-center text-center gap-4 p-6 rounded-lg hover:shadow-lg transition-all duration-200 min-h-[200px]',
							]"
						>
							<div
								class="bg-white rounded-full w-12 h-12 p-3 flex items-center justify-center"
							>
								<component
									:is="user.icon"
									class="w-6 h-6"
									:class="user.iconColor"
								/>
							</div>
	...
	const accountSetup = [
		{
			...
			title: "Parent",
			description:
				"I am a parent looking to track my baby's health and milestones.",
			icon: Baby,
		...
		},
		{
			...
			description:
				"I am a medical practitioner looking to manage my patients' health records.",
